        ...
        <table id="usersTable" class="w-full border-collapse bg-white text-left text-sm text-gray-500 display responsive nowrap">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('.dataTables_wrapper .dataTables_filter input').addClass('border-gray-300 focus:border-pink-500 focus:ring-pink-500 rounded-md shadow-sm p-2');
                    $('.dataTables_wrapper .dataTables_length select').addClass('border-gray-300 focus:border-pink-500 focus:ring-pink-500 rounded-md shadow-sm p-2');
                });
            </script>
